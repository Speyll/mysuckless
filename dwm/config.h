...
static const char col_gray1[]       = "#163638";
static const char col_gray2[]       = "#262b35";
static const char col_gray3[]       = "#E5E9F0";
static const char col_gray4[]       = "#163638";
...
static Key keys[] = {
	...
	/* Toggle dmenu // status bar */
		...
		{ MODKEY|ControlMask,           XK_s,      togglebar,      {0} },
	...
	/* Special Keybindings */
		...
		{ MODKEY,                       XK_p, spawn,               {.v = file } },
		{ MODKEY|ShiftMask,             XK_s, spawn,               {.v = scriptlaunch } },
